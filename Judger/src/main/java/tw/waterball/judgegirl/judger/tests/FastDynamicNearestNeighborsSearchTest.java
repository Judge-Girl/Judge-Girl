...
public class FastDynamicNearestNeighborsSearchTest extends AbstractJudgerTest {
    @SneakyThrows
    @Override
    protected Problem getProblem() {
        FileInputStream fileInputStream = new FileInputStream(problemHomePath + "/10017/problem.json");
