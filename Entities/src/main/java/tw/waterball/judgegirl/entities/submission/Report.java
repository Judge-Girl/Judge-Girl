...
public class Report {
    ...
    private String name;
    private Supplier<Map<String, ?>> rawDataSupplier;

    public static RawDataReport fromData(Map<String, ?> data) {
        return new RawDataReport(data);
    }
    ...
    public static class RawDataReport extends Report {
        ...
        public RawDataReport(Map<String, ?> data) {
            super("RawDataReport", () -> data);
            this.data = data;
        }
