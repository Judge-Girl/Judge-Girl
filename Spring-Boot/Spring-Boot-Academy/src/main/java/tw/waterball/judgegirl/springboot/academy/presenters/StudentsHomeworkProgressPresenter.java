...
import tw.waterball.judgegirl.academy.domain.usecases.homework.HomeworkProgressPresenter;
import tw.waterball.judgegirl.primitives.Student;
import tw.waterball.judgegirl.academy.domain.usecases.homework.StudentSubmissionRecord;
 ...
 */
public class StudentsHomeworkProgressPresenter implements HomeworkProgressPresenter {

    private List<Integer> problemIds;
    private List<Student> students;
    private List<StudentSubmissionRecord> records;
    ...
    @Override
    public void showRecords(List<StudentSubmissionRecord> records) {
    ...
    public StudentsHomeworkProgress present() {
        ...
        var studentRecords = toMap(records, StudentSubmissionRecord::getStudentId, this::getStudentProgress);
    ...
    @NotNull
    private StudentsHomeworkProgress.StudentProgress getStudentProgress(StudentSubmissionRecord record) {
