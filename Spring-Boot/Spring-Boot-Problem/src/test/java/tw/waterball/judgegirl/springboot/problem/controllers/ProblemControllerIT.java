...
//    @BeforeEach
//    void setup() {
//        problem = ProblemStubs.template().build();
//        testcases = asList(
...
//                .andExpect(header().longValue("Content-Length", zippedProvidedCodes.length))
//                .andExpect(content().contentType("application/zip"))
//                .andExpect(content().bytes(zippedProvidedCodes));
//    }
//
...
//        byte[] zippedProvidedCodes = ZipUtils.zipFilesFromResources(providedCodePaths);
//        problemRepository.save(savedProblem);
//        String fileId = gridFsTemplate.store(new ByteArrayInputStream(zippedProvidedCodes),
